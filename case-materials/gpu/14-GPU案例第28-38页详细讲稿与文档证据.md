...
当前可见播放素材未绑定同一 `commit + runId` 的 decoder、同帧 trace 与故障回退，完整 Spike 仍为 `PENDING`。
...
| 37 | Progress Ledger + evidence | 汇总验收矩阵 |
| 38 | `06-工程验收计划.md` + evidence pack | Reviewer release verdict |
