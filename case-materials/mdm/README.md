...
> 素材标记统一使用：`[需用户补充 Uxx]`、`[工程开放项 Exx]`、`[可本地生成 Lxx]`。完整清单见 [16-用户补充素材清单.md](16-用户补充素材清单.md)，不要把所有 `PENDING` 都理解为需要用户提供。
...
| Story 工作包总账 | [15-Story工作包与模块变更账.md](15-Story工作包与模块变更账.md) | S1–S8 的真实类、RED、修改边界、测试、历史提交和证据缺口 |
| 用户素材清单 | [16-用户补充素材清单.md](16-用户补充素材清单.md) | 哪些必须由用户提供、怎么拍、怎么命名，以及哪些其实是工程开放项 |
